...
namespace UeSaveGame
{
	...
	{
		public EObjectUE4Version PackageVersionUE4;
		public EObjectUE5Version PackageVersionUE5;

		public readonly uint Version => PackageVersionUE5 >= EObjectUE5Version.INITIAL_VERSION ? (uint)PackageVersionUE5 : (uint)PackageVersionUE4;

		public static readonly PackageVersion LatestTested;
		...
		{
			return HashCode.Combine(PackageVersionUE4, PackageVersionUE5);
		}

		public override readonly bool Equals([NotNullWhen(true)] object? obj)
		{
			return obj is PackageVersion other
				&& PackageVersionUE4 == other.PackageVersionUE4
				&& PackageVersionUE5 == other.PackageVersionUE5;
		}
		...
		public static bool operator ==(PackageVersion a, EObjectUE4Version b)
		{
			return a.Version == (uint)b;
		}

		public static bool operator ==(EObjectUE4Version a, PackageVersion b)
		{
			return (uint)a == b.Version;
		}
		...
		public static bool operator ==(PackageVersion a, EObjectUE5Version b)
		{
			return a.Version == (uint)b;
		}

		public static bool operator ==(EObjectUE5Version a, PackageVersion b)
		{
			return (uint)a == b.Version;
		}
	...
	public enum EObjectUE5Version : uint
	{
		INVALID = 0,
	...
	public enum EObjectUE4Version : uint
	{
		// Licensee may use this to indicate a custom save format
		VER_CUSTOM = 0,
