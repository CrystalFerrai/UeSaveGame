...
{
	internal class DateTimeStructSerializer : StructDataSerializerBase
	{
		...
		public override void ToJson(IStructData? data, JsonWriter writer)
		{
			...
			DateTimeStruct datetimeStruct = (DateTimeStruct)data;
			DateTimeSerializer.ToJson(datetimeStruct.DateTime, writer);
		}
		...
		public override IStructData? FromJson(JsonReader reader)
		{
			...
			{
				DateTime = DateTimeSerializer.FromJson(reader)
			};
		}
	}
}
