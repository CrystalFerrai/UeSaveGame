...
{
	internal class LinearColorStructSerializer : StructDataSerializerBase
	{
		...
		public override void ToJson(IStructData? data, JsonWriter writer)
		{
			...
			LinearColorStruct linearColorStruct = (LinearColorStruct)data;
			LinearColorSerializer.ToJson(linearColorStruct.Value, writer);
		}

		public override IStructData? FromJson(JsonReader reader)
		{
			return new LinearColorStruct()
			{
				Value = LinearColorSerializer.FromJson(reader)
			};
		}
	}
}
