...
{
	internal class Vector2DStructSerializer : StructDataSerializerBase
	{
		...
		public override void ToJson(IStructData? data, JsonWriter writer)
		{
			...
			Vector2DStruct vectorStruct = (Vector2DStruct)data;
			Vector2DSerializer.ToJson(vectorStruct.Value, writer);
		}

		public override IStructData? FromJson(JsonReader reader)
		{
			return new Vector2DStruct()
			{
				Value = Vector2DSerializer.FromJson(reader)
			};
		}
	}
}
