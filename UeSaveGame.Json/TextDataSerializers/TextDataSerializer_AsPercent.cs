...
{
	internal class TextDataSerializer_AsPercent : ITextDataSerializer
	{
		public void ToJson(ITextData? data, JsonWriter writer)
		{
			NumberTextDataSerializer.ToJson(data, writer);
		}

		public ITextData? FromJson(JsonReader reader)
		{
			TextData_AsPercent textData = new();
			NumberTextDataSerializer.FromJson(reader, textData);
			return textData;
		}
	}
}
